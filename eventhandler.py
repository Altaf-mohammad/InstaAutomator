...
path = 'C:\Users\Altaf\AppData\Local\Programs\Python\Python37-32\Lib\InstaAutomate\posts'
class MyHandler(FileSystemEventHandler):
    i = 1
    new_description = ''
    def on_modified(self, event):
        self.i = 1
        folder_path = 'C:\Users\Altaf\AppData\Local\Programs\Python\Python37-32\Lib\InstaAutomate\production_ready_posts'
        list_of_file_names = []
